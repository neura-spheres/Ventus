...
mod win {
    ...
    fn set_enabled(ext: ICoreWebView2BrowserExtension, enabled: bool) {
    ...
    fn add(profile: ICoreWebView2Profile7, dir: String, enabled: bool) {
